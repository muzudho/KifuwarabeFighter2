...
namespace DojinCircleGrayscale.StellaQL.Acons.Main_Char3
{
    ...
    /// It was created by [Generate C# (Motor)] button.
    /// </summary>
    public abstract class Main_Char3_AbstractMotor : AbstractMotor
    {
        #region Motion tags
        public const string
            ...
            MOTION_CHAR3_SWAIT = "Assets/Resources/AnimationClips/Char3@SWait.anim"; // semi colon
