...
public abstract class Hitbox2DDatabaseScript
{
    ...
    /// <returns></returns>
    public static int GetSerialImageIndex(CharacterIndex character, ActioningIndex image)
    {
    ...
    {
        ActioningIndex characterImageIndex = ActioningIndex.Num;
        slice = -1;
        ...
        switch(motion)
        {
            case MotionIndex.StandWait:
                {
                    // 立ち待機
                    characterImageIndex = ActioningIndex.Stand;
        ...
        serialImageIndex = Hitbox2DDatabaseScript.GetSerialImageIndex(character, characterImageIndex);
    }
}
