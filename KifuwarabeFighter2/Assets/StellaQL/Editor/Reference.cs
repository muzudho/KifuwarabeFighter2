...
namespace StellaQL
{
    ...
    public abstract class Reference
    {
        public static void ToContents(StringBuilder contents)
        {
            ...
            contents.AppendLine(@"");
            contents.AppendLine(@"    # 単語は１つ以上のスペース区切りです。 次の文はどちらも同じだぜ☆（＾▽＾）");
            ...
            contents.AppendLine(@"");
            contents.AppendLine(@"    # 命令文はセミコロン区切りだぜ☆（＾～＾）");
            ...
            contents.AppendLine(@"");
            contents.AppendLine(@"    # - NewLayer1 レイヤー、New Layer2 レイヤーを新規追加するぜ☆（＾▽＾）");
            ...
            contents.AppendLine(@"");
            contents.AppendLine(@"    # 出力先ファイル名に Zoo1, Zoo2 を付加するぜ☆（＾～＾）");
            ...
            contents.AppendLine(@"");
            contents.AppendLine(@"    # 出力先ファイル名に Zoo1 を付加するぜ☆（＾～＾）");
